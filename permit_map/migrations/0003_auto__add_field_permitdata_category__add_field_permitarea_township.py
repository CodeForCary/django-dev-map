...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PermitData.category'
        db.add_column(u'permit_map_permitdata', 'category',
                      self.gf('django.db.models.fields.CharField')(max_length=1024, null=True),
                      keep_default=False)

        # Adding field 'PermitArea.township'
        db.add_column(u'permit_map_permitarea', 'township',
                      self.gf('django.db.models.fields.CharField')(default='Cary', max_length=4),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PermitData.category'
        db.delete_column(u'permit_map_permitdata', 'category')

        # Deleting field 'PermitArea.township'
        db.delete_column(u'permit_map_permitarea', 'township')
